...
hoistedDependencies:
  ...
  '@vitest/mocker@3.1.1(vite@6.2.4(@types/node@22.13.17))':
  ...
  cors@2.8.5:
    cors: private
  create-jest@29.7.0(@types/node@22.13.17):
    create-jest: private
  cross-spawn@7.0.6:
    cross-spawn: private
  debug@4.4.0:
  ...
  jest-circus@29.7.0:
    jest-circus: private
  jest-cli@29.7.0(@types/node@22.13.17):
    jest-cli: private
  jest-config@29.7.0(@types/node@22.13.17):
    jest-config: private
  jest-diff@29.7.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Tue, 01 Apr 2025 16:40:07 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - '@rollup/rollup-win32-ia32-msvc@4.38.0'
  - '@rollup/rollup-win32-x64-msvc@4.38.0'
storeDir: /Users/kempb/Library/pnpm/store/v3
